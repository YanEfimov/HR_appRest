...
public class CandidateControllerTest {
    ...
    public void initData() {
        ...
        candidate.setBirthday(new Date());
        ...
        candidate1.setBirthday(new Date());
    ...
    public void CandidateSortNameTest() {
        when(dao.sort("name")).thenReturn(candidates);
        assertEquals(controller.CandidateSort("name"),candidates);
    }
}
